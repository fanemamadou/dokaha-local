...
class Vente(models.Model):
    ...
    plateaux = models.IntegerField(default=0, verbose_name='Nombre de plateaux (30 œufs)')
    reste_oeufs = models.IntegerField(default=0, verbose_name='Œufs restants (0-29)')
